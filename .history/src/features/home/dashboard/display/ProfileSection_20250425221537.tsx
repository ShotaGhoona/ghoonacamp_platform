export const ProfileSection = () => {
  return (
    <div className="w-full h-full flex flex-col items-center justify-center gap-5">
        <div className="w-full h-[20%] bg-white rounded-lg p-5 flex flex-col items-center justify-center">
            <p className="text-sm text-gray-300">将来の夢・ビジョン</p>
            <p className="text-sm text-center">AIの民主化によって世界を、生活を、1段階進化させる</p>
        </div>
