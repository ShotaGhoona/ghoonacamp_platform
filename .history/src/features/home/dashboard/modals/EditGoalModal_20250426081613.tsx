    ...
    <div className="flex flex-col justify-between h-[100%]">
      <div className="">
        ...
        <div className="space-y-4">
            ...
            />
            <label htmlFor="isPublic" className="text-sm text-gray-700" defaultChecked>
                目標を他のメンバーに公開する
            </label>
            </div>
        </div>
      ...
      <div className="flex justify-end gap-3 pt-4">
        ...
        <button
          className="px-4 py-2 text-sm font-medium text-white bg-[#5D6B80] border border-transparent rounded-md shadow-sm hover:bg-[#5D6B80] focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500"
        >
          保存する
        </button>
      </div>
