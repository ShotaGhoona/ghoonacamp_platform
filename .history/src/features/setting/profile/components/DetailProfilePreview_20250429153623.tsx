...
export const DetailProfilePreview = ({ formData }: DetailProfilePreviewProps) => {
  return (
    <>
    <div className="flex justify-center w-full bg-white rounded-lg p-5">
      <div className="flex gap-4">
        <img src={formData.avatarUrl} alt={formData.username} className="w-[200px] h-[200px] rounded-full" />
        <div>
          <div>
            <p>One-Line Profile</p>
            <p>{formData.oneLine}</p>
          </div>
          <div>
            <p>Background</p>
