...
import { ViewAllMemberGoalModal } from '../modals/ViewAllMemberGoalModal';

export const ProfileSection = () => {
  const { goals, isLoading, error } = useWeeklyGoals();
  const { isOpen, mode, openPopUp, closePopUp } = usePopUp();
  ...
  return (
    <>
      ...
      <PopUp 
        ...
        mode={mode}
        onClose={closePopUp}
        children={<EditGoalModal onClose={closePopUp} />}
        children2={<ViewAllMemberGoalModal onClose={closePopUp} />}
      />
    </>
  );
};
