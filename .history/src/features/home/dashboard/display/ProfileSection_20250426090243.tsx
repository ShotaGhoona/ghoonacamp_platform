...
import { LeftPopUp } from '@/components/display/LeftPopUp';
import { EditGoalModal } from '../modals/EditGoalModal';
import { ViewGoalsModal } from '../modals/ViewGoalsModal';
    ...
    <>
      ...
      {popUpType === 'center' ? (
        <PopUp isOpen={isOpen} onClose={closePopUp}>
          <EditGoalModal onClose={closePopUp} openLeftPopUp={handleOpenLeftPopUp} />
        </PopUp>
      ) : (
        <LeftPopUp isOpen={isOpen} onClose={closePopUp}>
          <ViewGoalsModal onClose={closePopUp} />
        </LeftPopUp>
      )}
    </>
  );
