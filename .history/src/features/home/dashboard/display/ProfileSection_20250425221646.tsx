  ...
  return (
    <div className="w-full h-full flex flex-col items-center justify-center gap-5">
        <div className="w-full h-[20%] bg-white rounded-lg p-5 flex flex-col">
            ...
            <p className="flex-1 text-3xl font-bold text-gradient from-blue-500 to-purple-500 text-center flex items-center justify-center">AIの民主化によって世界を、生活を、1段階進化させる</p>
        </div>
