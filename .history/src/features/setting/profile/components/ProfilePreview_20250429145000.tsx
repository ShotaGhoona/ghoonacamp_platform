...
export const ProfilePreview = ({ formData }: ProfilePreviewProps) => {
  return (
    ...
    <div className="flex justify-center  w-full gap-4 relative">
      ...
      <div className="w-[300px] h-full absolute top-0 -left-[100px] z-0 bg-linear-gradient-to-r from-white to-transparent z-10"></div>
      <div className="w-[300px] h-full absolute top-0 -right-[100px] z-0 bg-linear-gradient-to-r from-white to-transparent z-10"></div>
    </div>
