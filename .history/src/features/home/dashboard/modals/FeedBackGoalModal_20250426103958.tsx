...
export const FeedBackGoalModal = ({ onClose }: FeedBackGoalModalProps) => {
  ...
  return (
    <div className="flex flex-col h-[100%]">
      {/* タイトル */}
      <h2 className="text-2xl font-bold text-gray-800 mb-6">先週の目標へのフィードバック</h2>
      ...
      <div className="flex-1 overflow-y-auto pr-2">
        <div className="space-y-6">
          ...
          <div className="space-y-4">
            {currentGoals.map((goal) => (
              <div key={goal.id} className="space-y-2 bg-gray-100 rounded-lg px-5 py-3 min-h-[150px]">
                {/* 目標（読み取り専用） */}
                ...
                <div className="flex-1">
                  <input
                    type="text"
                    className="w-full py-2 bg-gray-100 focus:outline-none focus:ring-none"
