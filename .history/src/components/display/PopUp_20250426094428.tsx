...
export const PopUp = ({ isOpen, onClose, children, leftPanelContent, showLeftPanel = false }: PopUpProps) => {
  return (
    <>
      {/* オーバーレイ */}
      <div
      ...
      >
        ...
        {/* メインパネル */}
        <div className={`${showLeftPanel ? 'flex-1' : 'w-full'} h-[100%] bg-white rounded-lg shadow-xl transition-all duration-300`}>
