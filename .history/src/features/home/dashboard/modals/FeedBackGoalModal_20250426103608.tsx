    ...
    <div className="flex flex-col justify-between h-[100%]">
      <div className="space-y-6">
        ...
        <div className="space-y-4">
          {currentGoals.map((goal) => (
            <div key={goal.id} className="space-y-2 bg-gray-50 rounded-lg px-5 py-2 min-h-[150px]">
              {/* 目標（読み取り専用） */}
              ...
              <div className="flex-1">
                <input
                  type="text"
                  className="w-full py-2 focus:outline-none focus:ring-2 focus:ring-gray-300 focus:border-gray-300"
