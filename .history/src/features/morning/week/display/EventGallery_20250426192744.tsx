    ...
    return (
        <div className="flex flex-col gap-5 w-full h-full bg-white rounded-lg p-5">
            ...
            <div className="grid grid-cols-4 gap-5">
                <div className="h-[200px] border border-gray-200 rounded-lg p-5 flex flex-col justify-between">
                    <div>
                        <div className="flex justify-between">
                            <p className="text-sm">2/14</p>
                            <p className="text-sm">chat-room-3</p>
                        </div>
                        <h2 className="text-lg font-bold py-2 bg-linear-gradient-to-r from-[#5F7392] to-[#5F7392] text-transparent bg-clip-text">Notionを学ぼう</h2>
                        <p className="text-sm">Notion大好きな山下がNotionの魅力についてだらだら喋ったのち、みんなでNotionを構築していく会</p>
                    </div>
                    <div className="flex gap-2">
                        <div className="bg-gray-200 text-[10px] px-3 py-1 rounded-full">誰でも参加OK</div>
                        <div className="bg-gray-200 text-[10px] px-3 py-1 rounded-full">だらだら系</div>
                    </div>
                </div>
